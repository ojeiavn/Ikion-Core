...
from orion.backend.services.transcription import TranscriptGenerationService
...
class TranscriptGenerationServiceTests(unittest.TestCase):
    ...
    def test_generates_transcript_asset_and_marks_video_ready(self):
        ...
        self.assertEqual(transcript_asset.metadata["transcript_origin"], "orion_auto_generated")
