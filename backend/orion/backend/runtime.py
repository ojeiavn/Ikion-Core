...
def create_runtime(config: OrionConfig | None = None) -> OrionCoreRuntime:
    runtime_config = config or load_config()
    if runtime_config.google_drive_only and not runtime_config.google_drive_enabled:
        raise ValueError("ORION_GOOGLE_DRIVE_ONLY=true requires ORION_GOOGLE_DRIVE_ENABLED=true.")
