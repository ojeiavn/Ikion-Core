...
def build_embedding_provider(config: IkionConfig) -> EmbeddingProvider:
    if config.embedding_provider == "openai":
        if not config.openai_api_key:
            raise ValueError("IKION_EMBEDDING_PROVIDER=openai requires IKION_OPENAI_API_KEY or OPENAI_API_KEY.")
